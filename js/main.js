...
const facilityIcons = {
  ...
  '자동소화장치': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="5" y="8" width="14" height="12" rx="2"/><path d="M8 8V6a4 4 0 0 1 8 0v2"/><path d="M12 12v4"/><path d="M10 14h4"/><circle cx="12" cy="16" r="1"/></svg>',
